...
public class PlayerHealth : MonoBehaviour
{
    ...
    {
        Debug.Log("PlayerHealth Initialize");
        
        if (GameManager.Instance != null && GameManager.Instance.playerStats != null)
        {
            currentHealth = GameManager.Instance.playerStats.maxHealth;
        }
        else
        {
            currentHealth = 5;
    ...
    {
        float finalDamage = damageAmount - GameManager.Instance.playerStats.armor;
    ...
    private void Die()
    {
        ...
        int finalKills = GameManager.Instance.scoreManager.enemiesKilled;
        int finalLevel = GameManager.Instance.scoreManager.currentLevel;
